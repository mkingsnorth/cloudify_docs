...
At the bottom of the image, you can add a new noise displacement by adding a calculation to the existing position of each voxel.

See the `free tutorial wideo <https://youtu.be/fPFsNWzlxzk>`_ which explains the concept, and feel free to ask if you have questions.
